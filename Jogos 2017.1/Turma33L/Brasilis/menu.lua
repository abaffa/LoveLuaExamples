...
local botaoStart
local botaoQuit
iniciarIMG = love.graphics.newImage('iniciar.png')
sairIMG = love.graphics.newImage('sair.png')
function menu.load()
